...
const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navigation = [
    ...
    { name: "Bot Builder", href: "/bot-builder", icon: BrainCircuit },
    { name: "D Trader", href: "/d-trader", icon: BarChart3 },
    { name: "Tutorials", href: "/tutorials", icon: BookOpen },
    { name: "Analysis Tool", href: "/analysis-tool", icon: BarChart3 },
    { name: "DP Tool", href: "/dp-tool", icon: BarChart3 },
    { name: "Strategies", href: "/strategies", icon: BookOpen },
    { name: "Analysis", href: "/analysis", icon: BarChart3 },
    { name: "Free Bots", href: "/free-bots", icon: BrainCircuit },
                ...
                <Link key={item.name} to={item.href}>
                  <Button
                    ...
                    className={`px-4 py-2 rounded-none border-b-2 transition-colors ${
                      isActive 
                        ? "border-trading-orange text-trading-orange bg-trading-card" 
                        : "border-transparent text-muted-foreground hover:text-foreground hover:bg-trading-card/50"
                    }`}
                  >
